...
const Navbar = () => {
    ...
    useEffect(() => {
        if (windowWidth <= 609) {
            ...
            ref.current.style.width = '40%'
            ref.current.style.minWidth = '400px';
    ...
    return (
        ...
        <nav className='text-white bg-black fixed  top-0 flex shadow-gray-700 z-20 shadow-md items-center justify-between  gap-[10px]  w-[100vw] px-[1.5vw] flex-wrap'>
            <div className='flex items-center gap-[15px]'>
                <div className='menu'><span onClick={() => {windowWidth>593 && value.setMenu(!value.menu) }} className="cursor-pointer material-symbols-outlined flex items-center text-4xl">
                    menu
                </span></div>
                <Link to='/' className='icon cursor-pointer w-[130px]'>
            ...
            <div ref={ref} className='flex items-center  gap-[10px] justify-between'>
                <div className='flex items-center border w-[92%] border-red-500 rounded-full pr-[6px]'>
                    <input className='rounded-l-full pl-[10px] py-[3px] outline-none w-[97%]  bg-black' placeholder='Search' type="search" name="search" id="searchbar" />
                    <span ref={ref2} className="material-symbols-outlined cursor-pointer">
                        search
                    </span>
                </div>
                <div className="mic flex border-black border rounded-full p-[4px] items-center hover:text-black hover:bg-white"><span className="material-symbols-outlined cursor-pointer">
                    mic
                </span></div>
            ...
            </div>
            {
                windowWidth > 762 ?
                    ...
                    <div className='flex items-center gap-[2vw] '>
                        ...
                        <span className="material-symbols-outlined text-3xl font-light cursor-pointer">
                            person
                        </span>
